...
#model_path3 = os.path.join(working_dir3, 'models/Parkinsons_Prediction_Stacking_95%.sav') # new_Parkinsons_Prediction_stackingClassifier_92%.sav
...
# فتح الصورة وعرضها باستخدام Streamlit
  ...
  #  with col1:
   ...
   # with col2:
    ...
    df_prk = pd.DataFrame({'MDVP:Flo(Hz)':f1,'HNR':f2,'spread1':f3,
